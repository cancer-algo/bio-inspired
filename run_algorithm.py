...
def get_parameters(algo_name):
    ...
    while True:
        try:
            max_iter = int(
                input("Enter number of iterations (max 100): ") or 20
            )
            if max_iter > 500:
                print(
                    "Invalid input. The number of iterations cannot exceed 500."
                )
                continue
    ...
    if algo_name == "GA":
        while True:
            try:
                crossover_rate = float(
                    input("Enter crossover rate (max 1): ") or 0.8
                )
                if crossover_rate > 1:
        ...
        while True:
            try:
                mutation_rate = float(
                    input("Enter mutation rate (max 0.5): ") or 0.1
                )
        ...
        while True:
            try:
                evaporation_rate = float(
                    input("Enter evaporation rate (max 1): ") or 0.5
                )
        ...
        while True:
            try:
                max_pheromone = float(
                    input("Enter Max Pheromone (max 10): ") or 1.0
                )
                if max_pheromone > 10:
        ...
        while True:
            try:
                inertia_weight = float(
                    input("Enter inertia weight (max 1): ") or 0.7
                )
                if inertia_weight > 1:
        ...
        while True:
            try:
                size_penalty_weight = float(
                    input("Enter size penalty weight (e.g. 0.01): ") or 0.01
                )
...
def main():
    ...
    while True:
        ...
        while True:
            ...
            retry = input(
                "\nDo you want to (1) return to the main menu or (2) exit: "
            ).strip()
